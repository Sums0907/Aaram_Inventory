...
class PackerEventPayload(BaseModel):
    ...
    event_type: str = Field(..., description="The type of event, currently only PACKED is supported")
    ...
    items: List[PackerEventItem] = Field(..., min_length=1, description="List of items and quantities packed")
